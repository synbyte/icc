...
export default function Navigation() {
  ...
  return (<>
    <div className="flex justify-center w-full h-8 bg-brand-gold/90"><h1 className="text-lg font-bold tracking-wide text-brand-blue">Call 555-555-1234 today!</h1></div>
